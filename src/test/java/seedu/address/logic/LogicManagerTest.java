...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonBookKeeperStorage addressBookStorage =
                new JsonBookKeeperStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        // Inject LogicManager with an BookKeeperStorage that throws the IOException e when saving
        JsonBookKeeperStorage addressBookStorage = new JsonBookKeeperStorage(prefPath) {
            @Override
            public void saveAddressBook(ReadOnlyBookKeeper addressBook, Path filePath)
                    throws IOException {
                throw e;
            }
        };
